...
public enum ModArmorMaterials implements ArmorMaterial {
    LITHERITE("litherite", 28, new int[]{4, 7, 9, 4}, 19, SoundEvents.ARMOR_EQUIP_GOLD,
            3.5F, 0.3F, () -> Ingredient.of(ModItems.LITHERITE_CRYSTAL.get()));
    ...
    public String getName() {
        return Lithereal.MOD_ID + ":" + this.name;
    }
