...
public class ModConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_LITHERITE_ORES = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.LITHERITE_ORE.get().defaultBlockState()),
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_LITHERITE_ORE.get().defaultBlockState())));
